...
class   KnowledgeActivityMoneyScreen extends StatefulWidget {
  @override
  _KnowledgeActivityMoneyScreenState createState() => _KnowledgeActivityMoneyScreenState();
}

class _KnowledgeActivityMoneyScreenState extends State<KnowledgeActivityMoneyScreen> {
  ...
  _buildButtonTheory() {
    return WidgetButtonHome(
      ...
      height: 60,
      onTap: () => AppNavigator.navigateTestMoney(),
      enable: true,
  ...
  _buildButtonTest() {
    return WidgetButtonHome(
      ...
      height: 60,
      onTap: () => AppNavigator.navigateKnowledgeMoney(),
      enable: true,
      backgroundColor: COLORS.WHITE,
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
