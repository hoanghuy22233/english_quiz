...
class EnglishDetailTestScreen extends StatefulWidget {
  final int id;
  final Tests test;

  EnglishDetailTestScreen(this.id, this.test);

  _EnglishDetailTestScreenState createState() =>
      _EnglishDetailTestScreenState();
}

class _EnglishDetailTestScreenState extends State<EnglishDetailTestScreen>
  ...
  @override
  void initState() {
    BlocProvider.of<DetailQuestionsBloc>(context)
        .add(InitDetailQuestionsEvent(widget.id));
    super.initState();
  ...
  nextQuestion(UpdateDetailQuestionsState state) {
    Navigator.of(context).pushReplacement(MaterialPageRoute(
        builder: (_) =>
            QuizFinishedPage(questions: state.question, answers: _answers)));
  }
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...options
                                    .map((option) => MyRadioListTile<String>(
                                          // questions:
                                          //     '${questionLeading[options.indexOf(option)]}',
                                          title: Expanded(
                                            child: Text(
                                          ...
                                          leading:
                                              '${questionLeadings[options.indexOf(option)]}',
  ...
  Future<bool> showSumit(UpdateDetailQuestionsState state) async {
    ...
    this._answers.forEach((index, value) {
      if (state.question[index].answer == value) correct++;
    });
    return await showDialog(
          context: context,
          builder: (context) => AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  ResultBloc.of(context)
                      .add(InitResultEvent(widget.id, correct));
                  print("-------corrr----------");
                  print(correct);
                  print(widget.id);
                },
